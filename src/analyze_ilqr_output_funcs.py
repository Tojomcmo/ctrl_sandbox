...
def plot_ilqr_iter_sim_ctrl_cost(ilqr_config:ilqr.ilqrConfigStruct, controller_output:ilqr.ilqrControllerState, x_des_seq, x_sim_seq, u_sim_seq, figsize=(18,10)):
